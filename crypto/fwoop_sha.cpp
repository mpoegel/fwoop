...
const uint32_t SHA::SHA256_H0[] = {0x6A09E667, 0xBB67AE85, 0x3C6EF372, 0xA54FF53A,
...
{
    static uint8_t masks[8] = {/* 0 0b00000000 */ 0x00, /* 1 0b10000000 */ 0x80,
                               /* 2 0b11000000 */ 0xC0, /* 3 0b11100000 */ 0xE0,
                               /* 4 0b11110000 */ 0xF0, /* 5 0b11111000 */ 0xF8,
                               /* 6 0b11111100 */ 0xFC, /* 7 0b11111110 */ 0xFE};
    static uint8_t markbit[8] = {/* 0 0b10000000 */ 0x80, /* 1 0b01000000 */ 0x40,
...
int SHA::SHA256Context::SHA256AddLength(uint32_t length)
{
    ...
    LengthLow += length;
    Corrupted = LengthLow < addTemp && LengthHigh++ == 0 ? 1 : Corrupted;
    return 0;
}
...
int SHA::SHA256Context::SHA256ProcessMessageBlock()
{
    ...
    for (uint16_t t = 0, t4 = 0; t < 16; t++, t4 += 4) {
        W[t] = (((uint32_t)MessageBlock[t4]) << 24) | (((uint32_t)MessageBlock[t4 + 1]) << 16) |
               (((uint32_t)MessageBlock[t4 + 2]) << 8) | (((uint32_t)MessageBlock[t4 + 3]));
    }
