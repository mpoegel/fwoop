...
template<typename T>
void ArgParser::addNamedArg(const std::string& name, const std::string& flag, const T& defaultVal, const std::string& helpMsg)
{
...
template<typename T>
T ArgParser::getNamedArg(const std::string& argName) const
{
...
template<typename T>
T ArgParser::getPositionalArg(const std::string& argName) const
{
